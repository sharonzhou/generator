...
from pytorch_pretrained_biggan.config import BigGANConfig
from pytorch_pretrained_biggan.file_utils import cached_path
...
class BigGANPerturbationNet(nn.Module):
    """BigGAN Generator Deconstructed with Perturbation Net layers."""
    ...
    def __init__(self, config):
        super(BigGANPerturbationNet, self).__init__()
        self.config = config
